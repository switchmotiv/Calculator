...
for (var i = 0; i < keys.length; i++) {
    keys[i].onclick = function(e) {
        ...
        // If eval key is pressed, calculate and display the result
            ...
            // Final thing left to do is check the last character of the equation.
        ...
        // We can solve it easily using a flag 'decimalAdded' which we'll set once the decimal is
        // added and prevent more decimals to be added once it's set.
